...
class TongyiLargeLanguageModel(LargeLanguageModel):
    ...
    def _generate(
        ...
        # IMPORTANT: qwen3.5-xx models ALWAYS require incremental_output=True, regardless of thinking mode.
        qwen35_requires_incremental = model.startswith("qwen3.5-")
        if common_force_condition or model.startswith(("qwq-", "qvq-")) or qwen35_requires_incremental:
